...
public class Event {
	...
	public ArrayList<BasicData> getAdmin() {
		return Admin;
	}

	public ArrayList<BasicData> getStudent() {
		return Student;
	}
	...
	private static void ValidatePassword(@NotNull String password) throws PasswordValidationException {
		if (password.length() != 9) {
			...
			throw new PasswordValidationException("First letter of the Password should be p",
